...
people = [
  ...
  3, #1.JiříKmínek
  # 2, #2.AnnaBilčíková
  4, #3.VendulaVodičková
  # 4, #4.BrigitaRýdlová
  1, #5.ViktorieProcházková
  3, #6.AdélaHavlíčková
  2, #7.AdamZásměta
  1, #8.JanaSopčáková
  4, #9.FilipJíra
  3, #10.FilipHlubuček
  2, #11.VojtěchPavlíček
  # 1, #12.VojtěchBilčík
  # 2, #13.OliverBudiš
  1, #14.AloisPekárek
  4, #15.JulieKaňáková
  ...
  4, #17.MikulášVodička
  3, #18.RostislavHušák
  1, #19.AntonínPavlíček
  2, #20.EmílieProcházková
  1, #21.JanJíra
  2, #22.Justýna JitkaHliňáková
  3, #23.AntonínBůžek
  4, #24.AdélaZásmětová
  4, #25.KateřinaValentová
  2, #26.TomášHavlíček
  3, #27.TomášKučera
  1, #28.VojtěchŽelezný
  2, #29.TerezaHejhalová
  4, #30.JonášPáv
  3, #31.HedvikaKučerová
  1, #32.SofieKučerová
  4, #33.Jáchym JiříHliňák
  3, #34.BarboraSmolíková
  2, #35.RichardKaňák
  # 1, #36.MartaPřečková
]
