...
def displayname():
  ...
  lcd_string(">>>   Bystrice   <<<",LCD_LINE_2)
...
def main():
  ...
  lcd_string(">áF   kšěččlař š <ěé",LCD_LINE_1)
  lcd_string("íéáý+čříéášěčýřéíáíé",LCD_LINE_2)
  lcd_string("#####ěščpýžečěř#####",LCD_LINE_4)
  ...
  clear()
  lcd_string("  ...restartuji     ",LCD_LINE_3)
  sleep(60)
  lcd_string("####################",LCD_LINE_1)
  lcd_string("                    ",LCD_LINE_2)
  lcd_string("####################",LCD_LINE_3)
